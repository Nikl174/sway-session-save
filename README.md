...
### TODO I'm also going to implement an Interface for the session saving and
reconstruction to be able to use the software with other Tiling-WMs (linke i3
or Hyprland). #### 1. Version goals
- [x]   get a structure and all windows and save it
   ...
   - [ ]   terminals ??
   - [ ]   create interface for different programms to override
   reconstruction/state-save
- [ ]   recreate the tree
    - [ ]   reconstruct programms based on a basic and a programm-specific
    routine
    - [ ]   how to handle multible window instances?
- [ ]   testing ??!!
- [ ]   optionally show 'reconstructing-panel' in wlr-layer-shell protocol
while script is running 
    - [ ]   block user input?
- [ ]  optional: get all running programms (like
[here](https://github.com/gumieri/sway[]session))
